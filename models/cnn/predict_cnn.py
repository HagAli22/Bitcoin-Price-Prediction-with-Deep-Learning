...
class CNNPredictor:
    ...
    def load_model_and_scaler(self):
        ...
        try:
            ...
            print(self.model.summary())  # اختياري
    ...
    def predict_multiple_steps(self, df, n_steps=5, target_col='close'):
        ...
        for step in range(n_steps):
            ...
            # Create new row with predicted price (simplified approach)
            # In practice, you might want to predict all OHLCV values
            last_row = current_df.iloc[-1].copy()
            last_row[target_col] = next_price
            
            # Add the new row to the dataframe
            new_index = current_df.index[-1] + pd.Timedelta(days=1)  # Assuming daily data
...
def main():
    ...
    # model_path = 'saved_models/btc_cnn_model.h5'
    # scaler_path = 'saved_models/cnn_scaler.pkl'

    model_path = 'cnn_model (1).keras'
    scaler_path = 'scaler.pkl'
    
    # Initialize predictor
    predictor = CNNPredictor(model_path, scaler_path)
